...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/db-dtypes-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14521&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/db-dtypes-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `db-dtypes` can be installed with:

```
conda install db-dtypes
```

It is possible to list all of the versions of `db-dtypes` available on your platform with:
